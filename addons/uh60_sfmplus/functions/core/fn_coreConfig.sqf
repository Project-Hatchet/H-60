...
_heli setVariable ["vtx_uh60_sfmplus_emptyMassFCR",    	getNumber (_config >> "emptyMassFCR")]; //kg
_heli setVariable ["vtx_uh60_sfmplus_emptyMassNonFCR", 	getNumber (_config >> "emptyMassNonFCR")]; //kg
...
_heli setVariable ["vtx_uh60_sfmplus_maxFwdFuelMass", 	getNumber (_config >> "maxFwdFuelMass")];	    //1043lbs in kg
...
_heli setVariable ["vtx_uh60_sfmplus_maxAftFuelMass", 	getNumber (_config >> "maxAftFuelMass")]; 	//1474lbs in kg
