...
#define ASE_DISABLED_NONE USERVALLT(USERMFDV_R22,1) // "pylonAmmo36 < 1"
#define ASE_DISABLED USERVALGT(USERMFDV_R22,0) // "pylonAmmo36 > 0"
#define FLIR_FUNCTIONAL USERVALGT(USERMFDV_R23,0) // "pylonAmmo37 > 0"
#define FLIR_DISABLED USERVALGT(USERMFDV_R23,0) // "pylonAmmo37 > 0"
