...
class mfd_any {
    FMS_BTN(FMS_1,"")
        buttonUp= QUOTE([ARR_4((_this select 0), FMS_PAGE_INDEX, FMS_1, true)] call vtx_uh60_fms_fnc_interact);
    };
  };
