private _displayName = LSTRING(RescueHoist);
...
_displayName = LSTRING(DeployHook);
...
_displayName = LSTRING(SecureHook);
...
_displayName = LSTRING(RecoverPerson);
...
_displayName = LSTRING(MoveToHook);
...
_displayName = LSTRING(RaiseHookToHeli);
...
_displayName = LSTRING(LowerHookToGround);
...
_displayName = LSTRING(StabilizeHook);
...
_displayName = LSTRING(RepairHoist Hook);
