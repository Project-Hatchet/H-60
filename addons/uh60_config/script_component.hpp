...
#define MASS_GUNNERSEATS    30.8 // 20 kg/seat x2
#define MASS_CABINSEATS     91.2 // 10 kg/seat x11
#define MASS_CABINSEATS3    24.9 // 10 kg/seat x3
#define MASS_CABINSEATS4    33.1 // 10 kg/seat x4
