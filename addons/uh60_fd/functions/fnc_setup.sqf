...
[_vehicle, "collectiveSFM", 2000, 20, 0] call hatchet_util_fnc_pidCreate;
[_vehicle, "ias", 1, 0, 0] call hatchet_util_fnc_pidCreate;
[_vehicle, "pitch", 500, 0, 0] call hatchet_util_fnc_pidCreate;
[_vehicle, "hdg", 30, 0, 0] call hatchet_util_fnc_pidCreate;
[_vehicle, "roll", 10, 0, 0] call hatchet_util_fnc_pidCreate;
[_vehicle, "drift", 1, 0, 0] call hatchet_util_fnc_pidCreate;
