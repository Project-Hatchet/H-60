...
setCustomSoundController [_vehicle, "CustomSoundController7", (_eng1Powered + _eng2Powered)*_master min 1];
...
setCustomSoundController [_vehicle, "CustomSoundController6",
