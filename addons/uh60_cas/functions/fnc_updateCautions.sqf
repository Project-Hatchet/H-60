...
_setPylonFn = {
    ...
    _vehicle setUserMFDValue [_index, parseNumber _enable];
    if (_return == 2) then {
...
[USERMFDV_L01, _np < 0.3] call _setPylonFn;
[USERMFDV_R01, _np < 0.3] call _setPylonFn;


// CHIP ENG 1
private _chipeng1 = (_vehicle getHitPointDamage "hitengine1") > 0.2;
[USERMFDV_L10, _chipeng1] call _setPylonFn;
// CHIP ENG 2
private _chipeng2 = (_vehicle getHitPointDamage "hitengine2") > 0.2;
[USERMFDV_R10, _chipeng2] call _setPylonFn;
...
[USERMFDV_L12, _trot > 0.2] call _setPylonFn;
[USERMFDV_R11, _trot > 0.5] call _setPylonFn;
[USERMFDV_R12, (_vehicle getHitPointDamage "hitvrotor") > 0.8] call _setPylonFn;
...
[USERMFDV_R20, _stbyInst] call _setPylonFn;
...
[USERMFDV_L11, _mrot > 0.5] call _setPylonFn;
