...
_apuFuelSwitchState = ["OFF","ON"] select (_apuFuelSwitchPos <= 0.10);
...
_apuPwrSwitchState = ["OFF","ON"] select (_apuPwrSwitchPos <= 0.10);
...
_batt1SwitchState = ["OFF","ON"] select (_batt1SwitchPos <= 0.10);
...
_batt2SwitchState = ["OFF","ON"] select (_batt2SwitchPos <= 0.10);
