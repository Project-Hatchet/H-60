...
{
	volume="camInt*CustomSoundController9*(playerPos envelope [0,1,1.5,3])*(CustomSoundController16+1)*((rotorSpeed factor [0.3, 0.5])+((lateralMovement*((speed factor [5,40])+(speed factor [-5,-40])) max 0) min 1.5))";
};
