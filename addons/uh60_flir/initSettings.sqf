...
[
    ...
    "SLIDER", // setting type
    ["FLIR Aim Slew Speed", "Sensitivity when slewing the FLIR using mouse or 'Aim <▲◄▼►>' inputs."], // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    ["UH-60M", "FLIR"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
...
[
    "vtx_uh60_flir_setting_useCopilotAI", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
