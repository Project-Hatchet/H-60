...
class Draw {
	...
	class eicas {
		...
		EICAS_LINE(Left_1_4,0.05,0.45+(EICAS_LINE_SPACING*4),pylonAmmo23,"")
		...
		EICAS_LINE(Right_1_4,0.69,0.45+(EICAS_LINE_SPACING*4),pylonAmmo32,"")
		...
		EICAS_LINE(Right_2_4,0.69,0.70+(EICAS_LINE_SPACING*4),pylonAmmo38,"MFD FAIL")
