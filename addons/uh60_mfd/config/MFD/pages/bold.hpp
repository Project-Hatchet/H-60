...
class Draw {
	...
	class eicas {
		...
		EICAS_LINE(Left_1_4,0.05,0.45+(EICAS_LINE_SPACING*4),pylonAmmo23,"BATT LOW")
		...
		EICAS_LINE(Right_0_2,0.69,0.02+(EICAS_LINE_SPACING*2),pylonAmmo27,"EGI FAIL")
		...
		EICAS_LINE(Right_1_4,0.69,0.45+(EICAS_LINE_SPACING*4),pylonAmmo32,"STAB FAIL")
		...
		EICAS_LINE(Right_2_1,0.69,0.70+(EICAS_LINE_SPACING*1),pylonAmmo35,"STAB FAIL")
		...
		EICAS_LINE(Right_2_4,0.69,0.70+(EICAS_LINE_SPACING*4),pylonAmmo38,"")
