...
TEXT_LEFT_SCALED_USERTEXT(ROOMNUM,0.01,0.66+JOIN_BOX_OFFSET,49,0.05)
...
class credits_box {
  ...
  points[] ={
    ...
    {{0.95-0.05+0.05, 0.85},1},
    {{0.65+0.05+0.05, 0.85},1},
    {{0.65+0.05+0.05, 0.30},1}
  };
}; // HEADER_BARS
...
TEXT_MID_SCALED(CREDITS08,0.8+0.05,0.32+(CREDITS_LINE_HEIGHT*08),"BroBeans",0.05)
TEXT_MID_SCALED(CREDITS09,0.8+0.05,0.32+(CREDITS_LINE_HEIGHT*09),"Xovolovo",0.05)
