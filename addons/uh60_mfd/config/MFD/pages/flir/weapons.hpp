...
class Lasers {
	BOXEDTEXT(LRFDA,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD A",COND_ISNUMPYLON(45,0))
	BOXEDTEXT(LRFDB,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD B",COND_ISNUMPYLON(45,1))
	BOXEDTEXT(LRFDC,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD C",COND_ISNUMPYLON(45,2))
	BOXEDTEXT(LRFDD,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD D",COND_ISNUMPYLON(45,3))
	BOXEDTEXT(LRFDE,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD E",COND_ISNUMPYLON(45,4))
	BOXEDTEXT(LRFDF,0.05,(BEZEL_Y6-0.02),0.08,0.04,"LRFD F",COND_ISNUMPYLON(45,5))
	
	BOXEDTEXT(LSTA,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST A",COND_ISNUMPYLON(44,0))
	BOXEDTEXT(LSTB,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST B",COND_ISNUMPYLON(44,1))
	BOXEDTEXT(LSTC,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST C",COND_ISNUMPYLON(44,2))
	BOXEDTEXT(LSTD,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST D",COND_ISNUMPYLON(44,3))
	BOXEDTEXT(LSTE,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST E",COND_ISNUMPYLON(44,4))
	BOXEDTEXT(LSTF,0.05,(BEZEL_Y6+0.02),0.07,0.04,"LST F",COND_ISNUMPYLON(44,5))
