...
class flirPage {
	...
	class homepage_only {
		...
		BOXEDTEXT(SLEW,0.93,BEZEL_Y5-0.02,0.1,0.04,"SLEW","1")
		BOXEDTEXT(WAYPT,0.93,BEZEL_Y5+0.02,0.1,0.04,"WAYPT","1")
		
		BOXEDTEXT(CREATE,0.93,BEZEL_Y6-0.02,0.1,0.04,"CREATE","1")
		BOXEDTEXT(WAYPT2,0.93,BEZEL_Y6+0.02,0.1,0.04,"WAYPT","1")
