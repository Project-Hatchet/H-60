...
// TEXT_MID_SCALED(CONFIG,1-0.25,0.43,"hct_DRIVER",0.035)
...
TEXT_MID_SCALED_USERTEXT(CONFIG1,0.25,0.4+(0.03*0),45,0.035)
TEXT_MID_SCALED_USERTEXT(CONFIG2,0.25,0.4+(0.03*1),46,0.035)
TEXT_MID_SCALED_USERTEXT(CONFIG3,0.25,0.4+(0.03*2),47,0.035)
...
TEXT_MID_SCALED(ACE_VERS,1-0.5,0.4+(0.03*0),"ACE",0.035) //ACE
TEXT_MID_SCALED_USERTEXT(CONFIG5,1-0.5,0.4+(0.03*1),48,0.035)
TEXT_MID_SCALED(CBA_VERS,1-0.5,0.4+(0.03*2),"CBA",0.035) //CBA
TEXT_MID_SCALED_USERTEXT(CONFIG7,1-0.5,0.4+(0.03*3),49,0.035)
...
TEXT_LEFT_SCALED_USERTEXT(MODS,0.1,0.75,38,0.035)
TEXT_LEFT_SCALED_USERTEXT(MODS2,0.1,0.78,39,0.035)
TEXT_LEFT_SCALED_USERTEXT(MODS3,0.1,0.81,40,0.035)
...
TEXT_MID_SCALED(TOP4,0.63,0.01,"NUMS",0.035)
