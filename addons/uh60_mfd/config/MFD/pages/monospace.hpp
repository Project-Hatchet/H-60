...
class Draw {
	...
	class eicas {
		...
		EICAS_LINE_TEXT(Left_1_4,0.05,0.45+(EICAS_LINE_SPACING*4),pylonAmmo23,"LEFT STN HANG")
		...
		EICAS_LINE_TEXT(Right_1_4,0.69,0.45+(EICAS_LINE_SPACING*4),pylonAmmo32,"RIGHT STN HANG")
		...
		EICAS_LINE_TEXT(Right_2_4,0.69,0.70+(EICAS_LINE_SPACING*4),pylonAmmo38,"MFD BUS ERR")
