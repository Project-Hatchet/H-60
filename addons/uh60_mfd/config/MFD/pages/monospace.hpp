...
class Draw {
    ...
    EICAS_LINE_TEXT(Left_0_0,0.05,0.02+(EICAS_LINE_SPACING*0),USERMFDV_L00,"GEN 1 FAIL")
		EICAS_LINE_TEXT(Left_0_1,0.05,0.02+(EICAS_LINE_SPACING*1),USERMFDV_L01,"HYD PUMP 1 FAIL")
		EICAS_LINE_TEXT(Left_0_2,0.05,0.02+(EICAS_LINE_SPACING*2),USERMFDV_L02,"")
		EICAS_LINE_TEXT(Left_1_0,0.05,0.45+(EICAS_LINE_SPACING*0),USERMFDV_L10,"CHIP ENG 1")
		EICAS_LINE_TEXT(Left_1_1,0.05,0.45+(EICAS_LINE_SPACING*1),USERMFDV_L11,"CHIP MAIN MDL SUMP")
		EICAS_LINE_TEXT(Left_1_2,0.05,0.45+(EICAS_LINE_SPACING*2),USERMFDV_L12,"MAIN XMSN PRES")
		EICAS_LINE_TEXT(Left_1_3,0.05,0.45+(EICAS_LINE_SPACING*3),USERMFDV_L13,"HULL INTEGRITY CRIT")
		EICAS_LINE_TEXT(Left_1_4,0.05,0.45+(EICAS_LINE_SPACING*4),USERMFDV_L14,"LEFT STN HANG")
		EICAS_LINE_TEXT(Left_1_5,0.05,0.45+(EICAS_LINE_SPACING*5),USERMFDV_L15,"ENG 1 STARTER ON")
		EICAS_LINE_TEXT(Right_0_0,0.69,0.02+(EICAS_LINE_SPACING*0),USERMFDV_R00,"GEN 2 FAIL")
		EICAS_LINE_TEXT(Right_0_1,0.69,0.02+(EICAS_LINE_SPACING*1),USERMFDV_R01,"HYD PUMP 2")
		EICAS_LINE_TEXT(Right_0_2,0.69,0.02+(EICAS_LINE_SPACING*2),USERMFDV_R02,"")
		EICAS_LINE_TEXT(Right_1_0,0.69,0.45+(EICAS_LINE_SPACING*0),USERMFDV_R10,"CHIP ENG 2")
		EICAS_LINE_TEXT(Right_1_1,0.69,0.45+(EICAS_LINE_SPACING*1),USERMFDV_R11,"T/R SERVO 1 FAIL")
		EICAS_LINE_TEXT(Right_1_2,0.69,0.45+(EICAS_LINE_SPACING*2),USERMFDV_R12,"T/R QUAD FAIL")
		EICAS_LINE_TEXT(Right_1_3,0.69,0.45+(EICAS_LINE_SPACING*3),USERMFDV_R13,"APU FAIL")
		EICAS_LINE_TEXT(Right_1_4,0.69,0.45+(EICAS_LINE_SPACING*4),USERMFDV_R14,"RIGHT STN HANG")
		EICAS_LINE_TEXT(Right_1_5,0.69,0.45+(EICAS_LINE_SPACING*5),USERMFDV_R15,"ENG 2 STARTER ON")
		EICAS_LINE_TEXT(Right_2_0,0.69,0.70+(EICAS_LINE_SPACING*0),USERMFDV_R20,"STBY INST NOT ARMD")
		EICAS_LINE_TEXT(Right_2_1,0.69,0.70+(EICAS_LINE_SPACING*1),USERMFDV_R21,"")
		EICAS_LINE_TEXT(Right_2_2,0.69,0.70+(EICAS_LINE_SPACING*2),USERMFDV_R22,"CMWS FAIL")
		EICAS_LINE_TEXT(Right_2_3,0.69,0.70+(EICAS_LINE_SPACING*3),USERMFDV_R23,"FLIR FAIL")
		EICAS_LINE_TEXT(Right_2_4,0.69,0.70+(EICAS_LINE_SPACING*4),USERMFDV_R24,"MFD BUS ERR")
		EICAS_LINE_TEXT(Right_2_5,0.69,0.70+(EICAS_LINE_SPACING*5),USERMFDV_R25,"")
	}; // eicas
	class tac {
