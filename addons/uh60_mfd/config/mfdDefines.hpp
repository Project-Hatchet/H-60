...
// FLIR SUBPAGES
#define FLIR_MODE_ATTACK (MFD_PAGE_FLIR+0.1)
#define FLIR_MODE_LASER (MFD_PAGE_FLIR+0.2)
#define FLIR_MODE_WPN_SEL (MFD_PAGE_FLIR+0.3)
#define FLIR_MODE_CHANNEL_SELECT (MFD_PAGE_FLIR+0.4)
